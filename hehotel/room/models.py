...
from com.mylib.validators import SNValidator 
...
class Room(models.Model):
    #sn = models.CharField(_(u'房号'),max_length=32,unique=True,validator=SNValidator)
    ...
    @property
    def order_user(self):
        return self.order_set.all()[0].member if self.status in [1,2] else None
